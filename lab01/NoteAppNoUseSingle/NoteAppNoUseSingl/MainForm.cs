...
namespace NoteApp
{
    public class MainForm : Form
    {
        ...
        {
            Text = "Менеджер заметок (БЕЗ паттерна)";
            Width = 460;
            Height = 520;
        ...
        private void RefreshList(System.Collections.Generic.List<Note> notes = null)
        {
        ...
        {
            // Передаём три разных Logger — наглядно показывает проблему
            new LogForm(
                repository.logger,
                editor.logger,
                controller.logger
